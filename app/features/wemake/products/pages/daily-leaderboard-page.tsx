    ...
    <div className="space-y-10">
      ...
      <div className="flex items-center justify-center gap-2">
        <Button variant="secondary" asChild>
          <Link
            to={`/wemake/products/leaderboards/daily/${previousDay.year}/${previousDay.month}/${previousDay.day}`}
          >
        ...
        {!isToday ? (
          <Button variant="secondary" asChild>
            <Link
              to={`/wemake/products/leaderboards/daily/${nextDay.year}/${nextDay.month}/${nextDay.day}`}
            >
